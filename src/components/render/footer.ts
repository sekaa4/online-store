...
export function renderFooter() {
  ...
  const wrapper: HTMLElement = createElement(ConstantsDom.DIV, footer, [
    ConstantsDom.WRAPPER,
    ConstantsDom.FOOTER_WRAPPER,
  ]);
  ...
  createElement(ConstantsDom.A, links, [ConstantsDom.DEFAULT], ConstantsDom.GITHUB, [
    [ConstantsDom.HREF, ConstantsDom.OCTOPR],
  ]);
  ...
  createElement(ConstantsDom.A, links_one, [ConstantsDom.DEFAULT], ConstantsDom.GITHUB, [
    [ConstantsDom.HREF, ConstantsDom.OCTOPR],
  ]);
  ...
  createElement(ConstantsDom.A, links_two, [ConstantsDom.DEFAULT], ConstantsDom.PRODUCT, [
    [ConstantsDom.HREF, ConstantsDom.OCTOPR],
  ]);
}
